<form id="qForm" class="form-horizontal" method="post" action="update">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-6">
            <input type="text" name="site_qrcode_one" class="form-control" value="${options['site_qrcode_one']}" placeholder="二维码(1)"></br>
            <input type="text" name="site_qrcode_two" class="form-control" value="${options['site_qrcode_two']}" placeholder="二维码(2)">
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-2 control-label">联系方式</label>
        <div class="col-sm-6">
            <input type="text" name="site_contact" class="form-control" value="${options['site_contact']}" placeholder="邮箱：</br> 手机：</br> QQ：</br> 微信：</br> ">
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-2 control-label">网站介绍</label>
        <div class="col-sm-6">
            <input type="text" name="site_introduce" class="form-control" value="${options['site_introduce']}" placeholder="网站介绍">
        </div>
    </div>
    <div class="form-group">
        <label class="col-sm-2 control-label">标题</label>
        <div class="col-sm-6">
            <input type="text" name="site_title_1" class="form-control" value="${options['site_title_1']}" placeholder="首页标题(1)"></br>
            <input type="text" name="site_title_2" class="form-control" value="${options['site_title_2']}" placeholder="首页标题(2)">
        </div>
