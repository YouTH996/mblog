...
<div class="panel panel-default widget">
    ...
    <div class="panel panel-default widget" style="text-align: center">
        <div class="panel-heading">
            <h3 class="panel-title show-comment"><i class="v4font v4-xiexian "></i>分享</h3>
        </div>
        <div style="padding: 3% 3%">
            <wb:share-button appkey="278337149" addition="full" type="button"></wb:share-button>
        </div>
    </div>
</@controls>
